...
try{
 ...
 check('original review HTML preserved byte-for-byte',Buffer.from(payload.html,'base64').equals(fs.readFileSync(path.join(root,'../data-plugin-standalone-review-2026-09-14.html'))));check('original review Markdown preserved byte-for-byte',Buffer.from(payload.markdown,'base64').equals(fs.readFileSync(path.join(root,'../data-plugin-standalone-review-2026-09-14.md'))));
