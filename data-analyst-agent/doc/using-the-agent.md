...
The selector is disabled while a run or SQL review is active. Finish or reject
the current review before changing source.
...
| `POST /api/runs/{run_id}/decisions` | Approve, edit, or reject SQL |
