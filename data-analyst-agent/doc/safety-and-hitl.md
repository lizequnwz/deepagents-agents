...
[`validation.py`](../text2sql_agent/backends/validation.py) parses SQL locally.
...
[`run_manager.py`](../text2sql_agent/run_manager.py):
...
[`SQLiteBackend`](../text2sql_agent/backends/sqlite.py) adds:
...
[`sql_tools.py`](../text2sql_agent/sql_tools.py) stores the capped result as an
...
[`stores.py`](../text2sql_agent/stores.py) associates every result with
