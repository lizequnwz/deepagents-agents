...
2. [`safety-and-hitl.md`](safety-and-hitl.md#trust-boundary)
3. [`backend-development.md`](backend-development.md#keep-backend-and-agent-contracts-separate)
...
2. Pydantic/domain contracts in [`text2sql_agent/schemas.py`](../text2sql_agent/schemas.py).
3. Runtime code in [`text2sql_agent/`](../text2sql_agent/).
