...
2. Call `inspect_advisor_upload`. Inspect its bounded raw rows, plausible header rows, headerless view, patterns, and samples. Do not use generic file tools on the upload.
