...
5. Legal firm suffixes are normalization-only. A close firm may support an exact name. A fuzzy name plus fuzzy firm cannot auto-match without exact city and state.
